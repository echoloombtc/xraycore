...
#  https://raw.githubusercontent.com/kenDevXD/permission/main/access 
...
echo ""
wget -q https://raw.githubusercontent.com/kenDevXD/xraycore/aio/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/kenDevXD/xraycore/aio/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/kenDevXD/xraycore/aio/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/kenDevXD/xraycore/aio/xtls/xtls.sh && chmod +x xtls.sh && ./xtls.sh
#Set Backup
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/kenDevXD/xraycore/aio/ssh/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/kenDevXD/xraycore/aio/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
#Install SSH Websocket
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/kenDevXD/xraycore/aio/openvpn/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#Download Extra Menu
echo -e "${tyblue}.------------------------------------------.${NC}"
echo -e "${tyblue}|           DOWNLOAD EXTRA MENU            |${NC}"
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/kenDevXD/xraycore/aio/menu/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/kenDevXD/xraycore/aio/version  )
